...
public class OldFilmUtils {
    ...
    private static final String requestURL = "https://imdb8.p.rapidapi" +
            ".com/title/get-overview-details?tconst=tt7126948";
    //private static final String testURL = "https://imdb8.p.rapidapi
    // .com/title/get-overview-details?tconst=tt7126948";
    private static final String allFilmIdURL = "https://imdb8.p.rapidapi" +
            ".com/title/get-most-popular-movies";
    private static final String TOP_RATED_FILMS_URL = "https://imdb8.p.rapidapi" +
            ".com/title/get-top-rated-movies";
    private static final String filmOverviewUrl = "https://imdb8.p.rapidapi" +
            ".com/title/get-overview-details?tconst=";
    private static final String VIDEO_ID_URL = "https://imdb8.p.rapidapi" +
            ".com/title/get-videos?tconst=";
    private static final String CAST_ID_URL = "https://imdb8.p.rapidapi" +
            ".com/title/get-top-cast?tconst=";
    private static final String MAIN_ACT_URL = "https://imdb8.p.rapidapi" +
            ".com/actors/get-bio?nconst=";
    private static final String CREW_URL = "https://imdb8.p.rapidapi" +
            ".com/title/get-top-crew?tconst=";
    private static final String PREVIEW_URL = "https://imdb8.p.rapidapi" +
            ".com/title/get-video-playback?viconst=";
